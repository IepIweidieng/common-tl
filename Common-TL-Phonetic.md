...
`⟨⟩ (None)` denotes that the phone is _not denoted_ in CTL.\
`⟨⟩ (None)` 表示 CTL 音標 _不標出_ 此音。

Items marked :x: are judged by phonologists to be _impossible_ to pronounce.\
被標記 :x: 的欄位被語音學家認為是 _不可能_ 的發音。

*italic* items are graphemes _borrowed from_ **TL** to denote the phonemes _not presenting in Taiwanese Hokkien_.\
*斜體* 表示 _借自_ **臺羅音標** _以標注臺灣閩南語沒有的音位_ 的字素。

**Bold** items are new graphemes introduced in CTL.\
**粗體**表示 CTL 新引入的字素。

Graphemes separated by `/` mean `⟨CTL Southern/CTL Nouthern⟩` transcription variant.\
被 `/` 分開的字素表示 `⟨CTL 南版/CTL 北版⟩` 的不同標法。
...
**Note ɹ̠**: Used in Taiwanese Hakka Southern Sixian dialect　用於臺灣客家語南四縣腔 \
**Note x**: The pronunciation of Bopomofo/Zhuyin "H" in Putonghua　注音聲母「ㄏ」的普通話發音 \
**Note ɥ**: Bopomofo/Zhuyin "Yu" as a medial　注音介母「ㄩ」

### Transcription differences between TL and CTL on initials 臺羅拼音與 CTL 音標在聲母上的標音差異

`◌` denotes any combination of vowel phonemes.\
`◌` 表示任意的母音音素的組合。
...
| | Bilabial <br> 雙唇音 | Alveolar <br> 齦音 | Velar <br> 軟顎音 | Glottal <br> 聲門音 | None <br> 無
:--- | :---: | :---: | :---: | :---: | :---:
...
- **-ㄥ**ㄦ [◌&#8288;**̃**˞ ] ⟨**-nn**rr⟩: Nasalization and erization; used in Mandarin; rarely used in colloquial Guoyu　兒化鼻化音；用於標準漢語；國語口語罕用
- THRS "-**nn**d" [◌&#8288;**̃**t̚] ⟨**-nn**t⟩: Used in Taiwanese Hakka  用於臺灣客家語

## Medial/Nucleus 中間位（韻頭）/音節核（主要韻母／韻腹）

### Vowels and semivowels 母音與半母音
...
*[Note:ɤ]: Bopomofo/Zhuyin "E"　注音「ㄜ
*[Note:ɐ]: The (first) nucleus of Mandarin finals "-ianr" and "-üanr"　標準漢語韻母 "ㄧㄢㄦ" 與 "ㄩㄢㄦ" 之韻腹
...
TL | IPA | CTL | 備註
:---: | :---: | :---: | ---
**i**ng <br> **i**k | [**iə̯**ŋ] <br> [**iə̯**k̚] | ⟨**ie**ng⟩ <br> ⟨**ie**k⟩ | Will be changed to 將改成 ⟨**ier**ng⟩ <br> Will be changed to 將改成 ⟨**ier**k⟩
i**e**ng <br> i**e**k | [i̯**ɛ**ŋ] <br> [i̯**ɛ**k̚] | ⟨i**ee**ng⟩ <br> ⟨i**ee**k⟩ | Irregular spelling 不規則拼音
**e**ng <br> **e**k | [**ɛ**ŋ] <br> [**ɛ**k̚] | ⟨**ee**ng⟩ <br> ⟨**ee**k⟩ | Irregular spelling 不規則拼音 <br> **e** [**e**] ⟨**e**⟩ ≠ **ee** [**ɛ**] ⟨**ee**⟩ <br> u**e** [u̯**e**] ⟨u**e**⟩ ≠ u**ee** [u̯**ɛ**] ⟨u**ee**⟩ <br> **e**h [**e**ʔ] ⟨**e**h⟩ ≠ **ee**h [**ɛ**ʔ] ⟨**ee**h⟩
i**o**nn <br> i**o**ng <br> i**o**k <br> i**o**nnh | ([**ɔ**]) | ⟨i**oo**nn⟩ <br> ⟨i**oo**ng⟩ <br> ⟨i**oo**k⟩ <br> ⟨i**oo**nnh⟩ | Irregular spelling 不規則拼音 <br> 	i**o** [i̯**ə**] ⟨i**o**⟩ ≠ i**oo** [i̯**ɔ**] ⟨i**oo**⟩ <br> i**o**h [i̯**ə**ʔ] ⟨i**o**h⟩ ≠ i**oo**h [i̯**ɔ**ʔ] ⟨i**oo**h⟩
**o**nn <br> **o**m <br> **o**ng <br> **o**p <br> **o**k <br> **o**nnh | ([**ɔ**]) | ⟨**oo**nn⟩ <br> ⟨**oo**m⟩ <br> ⟨**oo**ng⟩ <br> ⟨**oo**p⟩ <br> ⟨**oo**k⟩ <br> ⟨**oo**nnh⟩ | Irregular spelling 不規則拼音 <br> **o** [**ə**] ⟨**o**⟩ ≠ **oo** [**ɔ**] ⟨**oo**⟩ <br> **o**h [**ə**ʔ] ⟨**o**h⟩ ≠ **oo**h [**ɔ**ʔ] ⟨**oo**h⟩
**ia**n <br> **ia**t | ([**i̯ɛ**]) | ⟨**iee**n⟩ <br> ⟨**iee**t⟩ | For avoiding conflicts with THRS "**ia**n" ([**i̯a**n]) and "**ia**d" ([**i̯a**t̚]) used in Taiwanese Hakka Hailu and Southern Sixian dialects <br> 避免與客家語拼音方案用於拼寫海陸腔與南四縣腔的 "**ia**n" ([**i̯a**n]) 與 "**ia**d" ([**i̯a**t̚]) 衝突

### Syllabic consonant 成音節子音
...
**Note ㄭ2**: The final of Mandarin syllables "之吃施日"　標準漢語「之吃施日」等字韻母

## Tones 聲調

### Taiwanese Hokkien 臺灣閩南語

The tones are not prefixed.\
聲調無前綴。

Will be changed to be prefixed with `1`.\
將改成加上 `1` 前綴。

Tone | Name | TL | TL (number)
:--- | ---: | :---: | :---:
聲調 | 調名 | 臺羅 | 臺羅（數字）
0 | neutral 輕聲 | -&#8288;\-&#8288;a(h) | a(h)0
1 | dark level 陰平 | a | a1
2 | dark rising 陰上 | á | a2
3 | dark departing 陰去 | à | a3
4 | dark entering 陰入 | ah | ah4
5 | light level 陽平 | â | a5
6 | light rising 陽上 | ǎ | a6
7 | light departing 陽去 | ā | a7
8 | light entering 陽入 | a̍h | ah8
9 | "tone 9" 「第九調」 | a̋(h) | a(h)9
...
* Wikipedia contributors. (2021, February 21). Help:IPA/Taiwanese Hokkien. In Wikipedia, The Free Encyclopedia. Retrieved 19:26, September 2, 2021, from 
https://en.wikipedia.org/w/index.php?title=Help:IPA/Taiwanese_Hokkien&oldid=1008102504